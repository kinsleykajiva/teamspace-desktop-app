...
public class JanusServer implements Runnable, IJanusMessageObserver, IJanusSessionCreationCallbacks, IJanusAttachPluginCallbacks {
    ...
    public String serverUri = "wss://janus.conf.meetecho.com:8188";
    public final IJanusGatewayCallbacks gatewayObserver;
    public final RTCIceServer iceServers;
    ...
    private class AsyncAttach extends Task<Void> {

        private final IJanusPluginCallbacks cb;

        public AsyncAttach(IJanusPluginCallbacks connectionObserver) {
            this.cb = connectionObserver;
        }
    ...
    public JanusServer(IJanusGatewayCallbacks gatewayCallbacks) {
        ...
        System.out.println("xxxxxxxJanusServer: " + serverUri);
    }
    ...
    public void Attach(IJanusPluginCallbacks callbacks) {
        ...
        var t = new AsyncAttach(callbacks);
        new Thread(t).start();
    }
    ...
    @Override
    public void onOpen() {
        System.out.println("onOpenxxxxxxxxxx");
        createSession();
    }
